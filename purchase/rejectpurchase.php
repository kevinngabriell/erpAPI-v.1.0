...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $action = "Draft PO telah ditolak";

    $update_reject_query = "UPDATE purchaseOrder SET POStatus = '$purchase_order_status', UpdateBy = '$update_by', UpdateDt = '$currentDateTimeString' WHERE PONumber = '$purchase_order_number'";
    ...
    if(mysqli_query($connect, $update_reject_query) && mysqli_query($connect, $insert_action_query)){
