...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if($total_records > 0){
        $purchase_query = "SELECT A1.PONumber, A1.PODate, A1.POSupplier, A2.supplier_pic_name, A1.POPayment, A1.POOrigin, A1.POStatus, A1.POType, A1.POShipment, A3.PO_Status_Name, A1.InsertDt, A1.POShippingMarks, A1.PORemarks, A4.term_name, A1.POTerm, A1.POCurrency, A2.supplier_name, A5.shipment_name, A6.origin_name, A7.payment_name, A8.currency_name, A1.InsertBy, A9.PPNPercentage
            ...
            LEFT JOIN salesPPNType A9 ON A1.POPPN = A9.PPNType_id
