...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if ($startdate && $enddate && $startdate !== $enddate) {
        $purchase_query .= " AND A1.PODate BETWEEN '$startdate' AND '$enddate'";
    }

    if ($PONumber) {
        $purchase_query .= " AND A1.PONumber = '$PONumber'";
    }

    $purchase_query .= ") AS PivotData GROUP BY PONumber ORDER BY PONumber DESC";
