...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $pending_query = "SELECT COUNT(*) as pending FROM purchaseOrder WHERE POStatus = 'd7ab6134-d157-11ee-8' AND PODate >= CURDATE() - INTERVAL 1 MONTH";
    ...
    $top_item_query = "SELECT POI.POProductName, COUNT(*) AS frequency
                        ...
                        WHERE PO.PODate >= CURDATE() - INTERVAL 1 MONTH
    ...
    WHERE A2.PODate >= CURDATE() - INTERVAL 1 MONTH;";
