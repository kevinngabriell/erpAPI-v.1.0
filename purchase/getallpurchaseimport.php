...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if ($startdate && $enddate && $startdate !== $enddate) {
        $query .= " AND A1.PODate BETWEEN '$startdate' AND '$enddate'";
    }
    ...
    $query .= ") AS PivotData GROUP BY PONumber ORDER BY PONumber DESC";

    $purchase_result = mysqli_query($connect, $query);
