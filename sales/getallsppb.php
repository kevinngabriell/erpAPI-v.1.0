...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $SPPBNumber = isset($_GET['SPPBNumber']) ? $_GET['SPPBNumber'] : '';

    $query = "SELECT A1.SPPBNumber, A1.SPPBDate, A2.company_name, A4.SO_Status_Name, A1.InsertDt
              FROM salesSPPB A1
    ...
    if ($startdate && $enddate && $startdate !== $enddate) {
        $conditions[] = "A1.SPPBDate BETWEEN '$startdate' AND '$enddate'";
    }

    if ($SPPBNumber) {
        $conditions[] = "A1.SPPBNumber = '$SPPBNumber'";
    }
