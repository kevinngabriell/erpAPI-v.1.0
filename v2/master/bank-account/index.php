...
function createBankAccount($conn, $input, $username, $company_id) {
    ...
    $sql = "INSERT INTO " . APP_SCHEMA . ".bank_account
            (id, company_id, bank_number, bank_name, bank_branch, currency_id, is_primary, created_by, created_at)
            VALUES ('$bank_account_id', '$company_id', '$bank_number', '$bank_name', $bank_branch_sql, '$currency_id', $is_primary, '$username', '$now')";
