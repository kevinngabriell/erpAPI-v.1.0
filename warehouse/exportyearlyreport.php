<?php
// Export Laporan Stok Tahunan ke Excel (untuk kebutuhan Laporan SPT)
// GET params: year
...
$sheet->setTitle('Stok Tahunan');

$sheet->mergeCells('A1:F1');
$sheet->setCellValue('A1', "LAPORAN STOK TAHUNAN - $year");
$sheet->getStyle('A1')->getFont()->setBold(true)->setSize(13);
$sheet->getStyle('A1')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);

$sheet->mergeCells('A2:F2');
$sheet->setCellValue('A2', "Periode: $beginningOfYear s/d $endOfYear");
...
$filename = "Laporan_Stok_Tahunan_{$year}.xlsx";
